 ...
 * @since 1.0.0
 */
public class MelroseIOC extends AnAction {
    ...
    public void actionPerformed(AnActionEvent e) {
     ...
     if (TextUtils.isEmpty(mSelectedText)){
       ...
       if (TextUtils.isEmpty(mSelectedText)){
           mSelectedText = Messages.showInputDialog(project,"布局内容：（不需要输入R.layout.）","未选中布局内容，请输入layout",Messages.getInformationIcon());
           if (TextUtils.isEmpty(mSelectedText)) {
